...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<I7qevnvakipc8e>, false>;
        /**
...
type ICalls = {
    ...
    Utility: {
         ...
         *event is deposited.
         */
        batch: TxDescriptor<Anonymize<Ib2rn4mt1sunhc>>;
        /**
         ...
         */
        as_derivative: TxDescriptor<Anonymize<Ioggmih38jn5p>>;
        /**
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<Ib2rn4mt1sunhc>>;
        /**
         ...
         *- O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<I7kikq0lq3j5nt>>;
        /**
         *Send a batch of dispatch calls.
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<Ib2rn4mt1sunhc>>;
        /**
         ...
         *The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<I94bksv0vcqrqi>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<I1cl8ben2vk13c>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<I35f1740hcglnq>>;
        /**
         *Register approval for a dispatch to be made from a deterministic composite account if
         *approved by a total of `threshold - 1` of `other_signatories`.
         *
...
type IEvent = {
    System: {
         ...
         *An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<I1ckr6qon3imd6>>;
        /**
         *`:code` was updated.
         */
    ...
    Utility: {
         ...
         *well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<Ic4penlva5rle7>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<Ic1v8av6kloqdn>>;
        /**
         *A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<Ib0kr25sobuv4e>>;
    };
    Multisig: {
        /**
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<I9ln4d731vscpr>>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<I8jej92kiq08fd>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<Ie4147he0k05ud>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<Ie4147he0k05ud>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I48v5riethqckl>, call: Anonymize<Ie4147he0k05ud>], Anonymize<I2aronv5dost8e>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<I37t54q6r915g3>>;
    };
    /**
...
export type People_rococoDispatchError = Anonymize<Iftgakfm23o786>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type People_rococoQueries = QueryFromPalletsDef<PalletsTypedef>;
export type People_rococoCalls = TxFromPalletsDef<PalletsTypedef>;
export type People_rococoEvents = EventsFromPalletsDef<PalletsTypedef>;
export type People_rococoErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type People_rococoConstants = ConstFromPalletsDef<PalletsTypedef>;
export type People_rococoCallData = Anonymize<Ie4147he0k05ud> & {
    value: {
        type: string;
    };
};
export type People_rococoWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}`;
