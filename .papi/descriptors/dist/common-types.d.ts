...
export type I7qevnvakipc8e = Array<Anonymize<I6e1e3e0tgojqq>>;
export type I6e1e3e0tgojqq = {
    "phase": Phase;
    "event": Anonymize<I8jh8euag7ru6e>;
...
export type I8jh8euag7ru6e = AnonymousEnum<{
    "System": Anonymize<Idah2orp6t1t34>;
    ...
    "Utility": Anonymize<I802tv0jcr2c42>;
    "Multisig": Anonymize<I799jklv4sash1>;
    "Identity": Anonymize<Ibju6hjiipokne>;
    "IdentityMigrator": PolkadotRuntimeCommonIdentityMigratorEvent;
}>;
export type Idah2orp6t1t34 = AnonymousEnum<{
    /**
     ...
     *An extrinsic failed.
     */
    "ExtrinsicFailed": Anonymize<I1ckr6qon3imd6>;
    /**
     *`:code` was updated.
     */
...
export type I1ckr6qon3imd6 = {
    "dispatch_error": Anonymize<Iftgakfm23o786>;
    "dispatch_info": Anonymize<Ic9s8f85vjtncc>;
};
export type Iftgakfm23o786 = AnonymousEnum<{
    "Other": undefined;
    "CannotLookup": undefined;
    "BadOrigin": undefined;
    "Module": Anonymize<I8cbcdddrtinrr>;
...
export type I8cbcdddrtinrr = AnonymousEnum<{
...
export type I802tv0jcr2c42 = AnonymousEnum<{
    /**
     *Batch of dispatches did not complete fully. Index of first failing dispatch given, as
     *well as the error.
     */
    "BatchInterrupted": Anonymize<Ic4penlva5rle7>;
    /**
     ...
     */
    "ItemFailed": Anonymize<Ic1v8av6kloqdn>;
    /**
     *A call was dispatched.
     */
    "DispatchedAs": Anonymize<Ib0kr25sobuv4e>;
}>;
export type Ic4penlva5rle7 = {
    "index": number;
    "error": Anonymize<Iftgakfm23o786>;
};
export type Ic1v8av6kloqdn = {
    "error": Anonymize<Iftgakfm23o786>;
};
export type Ib0kr25sobuv4e = {
    "result": Anonymize<Iciie6gcstes4b>;
};
export type Iciie6gcstes4b = ResultPayload<undefined, Anonymize<Iftgakfm23o786>>;
export type I799jklv4sash1 = AnonymousEnum<{
    /**
     ...
     */
    "MultisigExecuted": Anonymize<I9ln4d731vscpr>;
    /**
...
export type Idk5s247snfui0 = AnonymousEnum<{
    /**
     ...
     *event is deposited.
     */
    "batch": Anonymize<Ib2rn4mt1sunhc>;
    /**
     ...
     */
    "as_derivative": Anonymize<Ioggmih38jn5p>;
    /**
     ...
     *- O(C) where C is the number of calls to be batched.
     */
    "batch_all": Anonymize<Ib2rn4mt1sunhc>;
    /**
     ...
     *- O(1).
     */
    "dispatch_as": Anonymize<I7kikq0lq3j5nt>;
    /**
     *Send a batch of dispatch calls.
     ...
     *- O(C) where C is the number of calls to be batched.
     */
    "force_batch": Anonymize<Ib2rn4mt1sunhc>;
    /**
     ...
     *The dispatch origin for this call must be _Root_.
     */
    "with_weight": Anonymize<I94bksv0vcqrqi>;
}>;
export type Ib2rn4mt1sunhc = {
    "calls": Anonymize<I4k4810eem55m2>;
};
export type I4k4810eem55m2 = Array<TxCallData>;
export type Ioggmih38jn5p = {
    "index": number;
    "call": TxCallData;
};
export type I7kikq0lq3j5nt = {
...
export type I94bksv0vcqrqi = {
    "call": TxCallData;
    "weight": Anonymize<I4q39t5hn830vp>;
};
export type Icbg1fqrrqs68i = AnonymousEnum<{
    /**
     ...
     */
    "as_multi_threshold_1": Anonymize<I1cl8ben2vk13c>;
    /**
     ...
     */
    "as_multi": Anonymize<I35f1740hcglnq>;
    /**
     *Register approval for a dispatch to be made from a deterministic composite account if
     *approved by a total of `threshold - 1` of `other_signatories`.
     *
...
export type I1cl8ben2vk13c = {
    "other_signatories": Anonymize<Ia2lhg7l2hilo3>;
    "call": TxCallData;
};
export type I35f1740hcglnq = {
    "threshold": number;
    "other_signatories": Anonymize<Ia2lhg7l2hilo3>;
...
export type I8jej92kiq08fd = ResultPayload<Anonymize<Iciie6gcstes4b>, TransactionValidityError>;
...
export type Ie4147he0k05ud = AnonymousEnum<{
    ...
    "Utility": Anonymize<Idk5s247snfui0>;
    "Multisig": Anonymize<Icbg1fqrrqs68i>;
...
export type I2aronv5dost8e = ResultPayload<Anonymize<I8hlel3f2findg>, Anonymize<I55ku9c5gk50hb>>;
export type I8hlel3f2findg = {
    "execution_result": Anonymize<I9bpnmf3vbik01>;
    "emitted_events": Anonymize<I68lg6hekaemhr>;
    "local_xcm"?: Anonymize<I3i0ce56p044d2>;
    "forwarded_xcms": Anonymize<I47tkk5e5nm6g7>;
};
export type I9bpnmf3vbik01 = ResultPayload<Anonymize<Ia1u1r3n74r13c>, Anonymize<Ieuatctomjgb86>>;
export type Ia1u1r3n74r13c = {
    "actual_weight"?: Anonymize<Iasb8k6ash5mjn>;
    "pays_fee": Anonymize<Iehg04bj71rkd>;
};
export type Ieuatctomjgb86 = {
    "post_info": Anonymize<Ia1u1r3n74r13c>;
    "error": Anonymize<Iftgakfm23o786>;
};
export type I68lg6hekaemhr = Array<Anonymize<I8jh8euag7ru6e>>;
...
export type I37t54q6r915g3 = ResultPayload<Anonymize<I1nrq6c7oldb0u>, Anonymize<I55ku9c5gk50hb>>;
export type I1nrq6c7oldb0u = {
...
export type I6v4b67onopa6 = Array<Anonymize<I3i2hss6lk47oa>>;
export type I3i2hss6lk47oa = {
    "phase": Phase;
    "event": Anonymize<I3qph4htrql9sg>;
    "topics": Anonymize<Ic5m5lp1oioo8r>;
};
export type I3qph4htrql9sg = AnonymousEnum<{
    "System": Anonymize<I8fmdg9eima69p>;
    "Indices": Anonymize<IndicesEvent>;
    "Balances": Anonymize<Iao8h4hv7atnq3>;
    "TransactionPayment": TransactionPaymentEvent;
    "Staking": StakingEvent;
    ...
    "Session": SessionEvent;
    "Grandpa": GrandpaEvent;
    "Utility": Anonymize<Ieongoinmq8fmh>;
    "Identity": Anonymize<Ibju6hjiipokne>;
    "Recovery": RecoveryEvent;
    "Vesting": VestingEvent;
    "Scheduler": Anonymize<I9v8h6jcqtehe9>;
    "Preimage": PreimageEvent;
    "Sudo": Anonymize<I84n8ofp79eari>;
    "Proxy": Anonymize<I4afi8fjg3u0nh>;
    "Multisig": Anonymize<I14ovdl09btsbd>;
    "ElectionProviderMultiPhase": ElectionProviderMultiPhaseEvent;
    "VoterList": BagsListEvent;
    "NominationPools": Anonymize<I1mroqu3ca6qo2>;
    "FastUnstake": Anonymize<Ia6ucp3nfjftr9>;
    "ConvictionVoting": Anonymize<Itdqso6dq8jq1>;
    "Referenda": Anonymize<Idfraa3b4eu018>;
    "Whitelist": Anonymize<Iganl7i0a917g>;
    "Treasury": Anonymize<Iceo3qo846468b>;
    ...
    "Slots": CommonSlotsEvent;
    "Auctions": CommonAuctionsEvent;
    "Crowdloan": Anonymize<Ifae7gg6o0sc7c>;
...
export type I8fmdg9eima69p = AnonymousEnum<{
    /**
     *An extrinsic completed successfully.
     */
    "ExtrinsicSuccess": Anonymize<Ia82mnkmeo2rhc>;
     ...
     *An extrinsic failed.
     */
    "ExtrinsicFailed": Anonymize<Ibju3hpbfs2iqn>;
    /**
     *`:code` was updated.
     */
    "CodeUpdated": undefined;
...
export type Ibju3hpbfs2iqn = {
    "dispatch_error": Anonymize<I5sin1blmt46fa>;
    "dispatch_info": Anonymize<Ic9s8f85vjtncc>;
};
export type I5sin1blmt46fa = AnonymousEnum<{
    "Other": undefined;
    "CannotLookup": undefined;
    "BadOrigin": undefined;
    "Module": Anonymize<I8to32jr3eas60>;
    "ConsumerRemaining": undefined;
    "NoProviders": undefined;
    "TooManyConsumers": undefined;
    "Token": TokenError;
...
export type I8to32jr3eas60 = AnonymousEnum<{
    "System": Anonymize<I5o0s7c8q1cc9b>;
    "Babe": Anonymize<Ib6q602k6o213a>;
    "Timestamp": undefined;
    "Indices": Anonymize<Icq1825fru3di2>;
...
export type Ieongoinmq8fmh = AnonymousEnum<{
    /**
     *Batch of dispatches did not complete fully. Index of first failing dispatch given, as
     *well as the error.
     */
    "BatchInterrupted": Anonymize<I6p072u13n99sk>;
    /**
     *Batch of dispatches completed fully with no error.
     */
    "BatchCompleted": undefined;
     ...
     *A single item within a Batch of dispatches has completed with error.
     */
    "ItemFailed": Anonymize<I7bcclgooc9rcj>;
    /**
     *A call was dispatched.
     */
    "DispatchedAs": Anonymize<I91c07lmd1idf8>;
}>;
export type I6p072u13n99sk = {
    "index": number;
    "error": Anonymize<I5sin1blmt46fa>;
};
export type I7bcclgooc9rcj = {
    "error": Anonymize<I5sin1blmt46fa>;
};
export type I91c07lmd1idf8 = {
    "result": Anonymize<I3b91fl6leb2ls>;
};
export type I3b91fl6leb2ls = ResultPayload<undefined, Anonymize<I5sin1blmt46fa>>;
...
export type I9v8h6jcqtehe9 = AnonymousEnum<{
    /**
     *Scheduled some task.
     */
    "Scheduled": Anonymize<I5n4sebgkfr760>;
     ...
     *Dispatched some task.
     */
    "Dispatched": Anonymize<I5rqvtr25i1urc>;
    /**
     *Set a retry configuration for some task.
     */
    "RetrySet": Anonymize<Ia3c82eadg79bj>;
...
export type I5rqvtr25i1urc = {
    "task": Anonymize<I9jd27rnpm8ttv>;
    "id"?: Anonymize<I4s6vifaf8k998>;
    "result": Anonymize<I3b91fl6leb2ls>;
};
export type I84n8ofp79eari = AnonymousEnum<{
    /**
     *A sudo call just took place.
     */
    "Sudid": Anonymize<Ieu30614050ji>;
    /**
     ...
     */
    "SudoAsDone": Anonymize<Ieu30614050ji>;
}>;
export type Ieu30614050ji = {
    /**
     *The result of the call made by the sudo user.
     */
    "sudo_result": Anonymize<I3b91fl6leb2ls>;
};
...
export type I4afi8fjg3u0nh = AnonymousEnum<{
    /**
     *A proxy was executed correctly, with the given.
     */
    "ProxyExecuted": Anonymize<I91c07lmd1idf8>;
    /**
     *A pure account has been created by new proxy with given
     *disambiguation index and proxy type.
     */
...
export type I14ovdl09btsbd = AnonymousEnum<{
    /**
     *A new multisig operation has begun.
     */
    "NewMultisig": Anonymize<Iep27ialq4a7o7>;
     ...
     *A multisig operation has been executed.
     */
    "MultisigExecuted": Anonymize<I9ach436910bbm>;
    /**
     *A multisig operation has been cancelled.
     */
    "MultisigCancelled": Anonymize<I5qolde99acmd1>;
}>;
export type I9ach436910bbm = {
    "approving": SS58String;
    "timepoint": Anonymize<Itvprrpb0nm3o>;
    "multisig": SS58String;
    "call_hash": FixedSizeBinary<32>;
...
export type Ia6ucp3nfjftr9 = AnonymousEnum<{
    /**
     *A staker was unstaked.
     */
    "Unstaked": Anonymize<Ibi6t63pil4ovh>;
    /**
     *A staker was slashed for requesting fast-unstake whilst being exposed.
     */
    "Slashed": Anonymize<Ifk8eme5o7mukf>;
...
export type Iganl7i0a917g = AnonymousEnum<{
    "CallWhitelisted": Anonymize<I1adbcfi5uc62r>;
    "WhitelistedCallRemoved": Anonymize<I1adbcfi5uc62r>;
    "WhitelistedCallDispatched": Anonymize<I9oedgv6bmmopf>;
}>;
export type I9oedgv6bmmopf = {
    "call_hash": FixedSizeBinary<32>;
    "result": Anonymize<I1jq01a88pudo4>;
};
export type I1jq01a88pudo4 = ResultPayload<Anonymize<Ia1u1r3n74r13c>, Anonymize<I5phj1nlbbr2p>>;
export type I5phj1nlbbr2p = {
    "post_info": Anonymize<Ia1u1r3n74r13c>;
    "error": Anonymize<I5sin1blmt46fa>;
};
...
export type Ifae7gg6o0sc7c = AnonymousEnum<{
    /**
     *Create a new crowdloaning campaign.
     */
    "Created": Anonymize<I37r4bdai8o9mp>;
     ...
     *The result of trying to submit a new bid to the Slots pallet.
     */
    "HandleBidResult": Anonymize<Ibh0qdvfcg9l6o>;
    /**
     *The configuration to a crowdloan has been edited.
     */
    "Edited": Anonymize<I37r4bdai8o9mp>;
...
export type Ide1blqbentj5r = AnonymousEnum<{
    /**
     *Send a batch of dispatch calls.
     *
     *May be called from any origin except `None`.
     ...
     *event is deposited.
     */
    "batch": Anonymize<I7pop62itp0kde>;
    /**
     *Send a call through an indexed pseudonym of the sender.
     *
     *Filter from origin are passed along. The call will be dispatched with an origin which
     ...
     *The dispatch origin for this call must be _Signed_.
     */
    "as_derivative": Anonymize<Idm1qtl1ofh0ct>;
    /**
     *Send a batch of dispatch calls and atomically execute them.
     *The whole transaction will rollback and fail if any of the calls failed.
     *
     ...
     *- O(C) where C is the number of calls to be batched.
     */
    "batch_all": Anonymize<I7pop62itp0kde>;
    /**
     *Dispatches a function call with a provided origin.
     *
     *The dispatch origin for this call must be _Root_.
     ...
     *- O(1).
     */
    "dispatch_as": Anonymize<I250fomuefqpko>;
    /**
     *Send a batch of dispatch calls.
     *Unlike `batch`, it allows errors and won't interrupt.
     *
     ...
     *- O(C) where C is the number of calls to be batched.
     */
    "force_batch": Anonymize<I7pop62itp0kde>;
    /**
     *Dispatch a function call with a specified weight.
     *
     *This function does not check the weight of the call, and instead allows the
     ...
     *The dispatch origin for this call must be _Root_.
     */
    "with_weight": Anonymize<Ibhg5pp4jhd03k>;
}>;
export type I7pop62itp0kde = {
    "calls": Anonymize<I7o1p2ukvuqfnb>;
};
export type I7o1p2ukvuqfnb = Array<TxCallData>;
export type Idm1qtl1ofh0ct = {
    "index": number;
    "call": TxCallData;
};
export type I250fomuefqpko = {
    "as_origin": WestendRuntimeOriginCaller;
    "call": TxCallData;
};
export type Ibhg5pp4jhd03k = {
    "call": TxCallData;
    "weight": Anonymize<I4q39t5hn830vp>;
};
...
export type I5h4r2soeol68n = AnonymousEnum<{
    /**
     ...
     */
    "as_recovered": Anonymize<I1g9324djt0qu4>;
    /**
...
export type Ibf73oaefi8b5c = AnonymousEnum<{
    /**
     *Anonymously schedule a task.
     */
    "schedule": Anonymize<I4lgipau6u1088>;
    /**
     *Cancel an anonymously scheduled task.
     */
    "cancel": Anonymize<I5n4sebgkfr760>;
     ...
     *Schedule a named task.
     */
    "schedule_named": Anonymize<I1ucsql6dn998d>;
    /**
     *Cancel a named scheduled task.
     */
    "cancel_named": Anonymize<Ifs1i5fk9cqvr6>;
     ...
     *Anonymously schedule a task after a delay.
     */
    "schedule_after": Anonymize<I33c1lhrur48cq>;
    /**
     *Schedule a named task after a delay.
     */
    "schedule_named_after": Anonymize<I74jhlc0dde8r5>;
    /**
     *Set a retry configuration for a task so that, in case its scheduled run fails, it will
     *be retried after `period` blocks, for a total amount of `retries` retries or until it
     *succeeds.
...
export type I4lgipau6u1088 = {
    "when": number;
    "maybe_periodic"?: Anonymize<Iep7au1720bm0e>;
    "priority": number;
    "call": TxCallData;
};
export type I1ucsql6dn998d = {
    "id": FixedSizeBinary<32>;
    "when": number;
    "maybe_periodic"?: Anonymize<Iep7au1720bm0e>;
    "priority": number;
...
export type I33c1lhrur48cq = {
    "after": number;
    "maybe_periodic"?: Anonymize<Iep7au1720bm0e>;
    "priority": number;
    "call": TxCallData;
};
export type I74jhlc0dde8r5 = {
    "id": FixedSizeBinary<32>;
    "after": number;
    "maybe_periodic"?: Anonymize<Iep7au1720bm0e>;
    "priority": number;
...
export type I2jf8invls6c96 = AnonymousEnum<{
    /**
     *Authenticates the sudo key and dispatches a function call with `Root` origin.
     */
    "sudo": Anonymize<Idjsdr98o2hjnp>;
    /**
     *Authenticates the sudo key and dispatches a function call with `Root` origin.
     *This function does not check the weight of the call, and instead allows the
     ...
     *The dispatch origin for this call must be _Signed_.
     */
    "sudo_unchecked_weight": Anonymize<Ibhg5pp4jhd03k>;
    /**
     ...
     *The dispatch origin for this call must be _Signed_.
     */
    "sudo_as": Anonymize<Ibgcgpqeg2s3j2>;
    /**
...
export type Idjsdr98o2hjnp = {
    "call": TxCallData;
};
export type I8k3rnvpeeh4hv = {
    "new": MultiAddress;
};
export type Ibgcgpqeg2s3j2 = {
    "who": MultiAddress;
    "call": TxCallData;
};
export type I7da33piebufbm = AnonymousEnum<{
    /**
     *Dispatch the given `call` from an account that the sender is authorised for through
     *`add_proxy`.
     *
     ...
     *- `call`: The call to be made by the `real` account.
     */
    "proxy": Anonymize<I165sq3q4mrbab>;
    /**
     *Register a proxy account for the sender that is able to make calls on its behalf.
     *
     *The dispatch origin for this call must be _Signed_.
     ...
     *- `call`: The call to be made by the `real` account.
     */
    "proxy_announced": Anonymize<I66u7v5vqtsq2e>;
}>;
export type I165sq3q4mrbab = {
    "real": MultiAddress;
...
export type I66u7v5vqtsq2e = {
    "delegate": MultiAddress;
    "real": MultiAddress;
    "force_proxy_type"?: Anonymize<Idlkj5job825fk>;
    "call": TxCallData;
};
export type I7tb5tp5bn188g = AnonymousEnum<{
    /**
     *Immediately dispatch a multi-signature call using a single approval from the caller.
     *
     *The dispatch origin for this call must be _Signed_.
     ...
     *O(Z + C) where Z is the length of the call and C its execution weight.
     */
    "as_multi_threshold_1": Anonymize<Ia7b3k5fu7abi4>;
    /**
     *Register approval for a dispatch to be made from a deterministic composite account if
     *approved by a total of `threshold - 1` of `other_signatories`.
     *
     ...
     *  taken for its lifetime of `DepositBase + threshold * DepositFactor`.
     */
    "as_multi": Anonymize<I6auvd5ekrgkdn>;
    /**
     *Register approval for a dispatch to be made from a deterministic composite account if
     *approved by a total of `threshold - 1` of `other_signatories`.
     *
...
export type Ia7b3k5fu7abi4 = {
    "other_signatories": Anonymize<Ia2lhg7l2hilo3>;
    "call": TxCallData;
};
export type I6auvd5ekrgkdn = {
    "threshold": number;
    "other_signatories": Anonymize<Ia2lhg7l2hilo3>;
    "maybe_timepoint"?: Anonymize<I95jfd8j5cr5eh>;
    "call": TxCallData;
...
export type I78hmo92oc5nof = AnonymousEnum<{
    "whitelist_call": Anonymize<I1adbcfi5uc62r>;
    "remove_whitelisted_call": Anonymize<I1adbcfi5uc62r>;
    "dispatch_whitelisted_call": Anonymize<Ibf6ucefn8fh49>;
    "dispatch_whitelisted_call_with_preimage": Anonymize<Idjsdr98o2hjnp>;
}>;
...
export type Igmb4efctgkd5 = ResultPayload<Anonymize<I3b91fl6leb2ls>, TransactionValidityError>;
export type I25plekc1moieu = {
    "vote": Anonymize<I3eao7ea0kppv8>;
    "ancestry_proof": Binary;
    "header": Anonymize<Ic952bubvq4k7d>;
};
export type I4sjsopbi4ebef = AnonymousEnum<{
    "System": Anonymize<Iekve0i6djpd9f>;
    "Babe": Anonymize<I1jeo0dpbkma5g>;
    "Timestamp": Anonymize<I7d75gqfg6jh9c>;
    "Indices": Anonymize<I66vlm8f4l1oll>;
    ...
    "Session": Anonymize<Iceajactc9a8pc>;
    "Grandpa": Anonymize<I5u9ggmn8umfqm>;
    "Utility": Anonymize<Ide1blqbentj5r>;
    "Identity": Anonymize<I276doi9hm655d>;
    "Recovery": Anonymize<I5h4r2soeol68n>;
    "Vesting": Anonymize<Icgf8vmtkbnu4u>;
    "Scheduler": Anonymize<Ibf73oaefi8b5c>;
    "Preimage": Anonymize<If81ks88t5mpk5>;
    "Sudo": Anonymize<I2jf8invls6c96>;
    "Proxy": Anonymize<I7da33piebufbm>;
    "Multisig": Anonymize<I7tb5tp5bn188g>;
    "ElectionProviderMultiPhase": Anonymize<I15soeogelbbbh>;
    "VoterList": Anonymize<Ifvfo1l0vu2o7e>;
    "NominationPools": Anonymize<I57mljkkr28m9p>;
    "FastUnstake": Anonymize<I44snhj1gahvrd>;
    ...
    "Whitelist": Anonymize<I78hmo92oc5nof>;
    "Treasury": Anonymize<I1s28h18nhih63>;
    "Configuration": Anonymize<Ia9ptue949ognv>;
    "ParasShared": undefined;
    "ParaInclusion": undefined;
...
export type I2gvmcuqo309qi = ResultPayload<Anonymize<I34avjcohag6bs>, Anonymize<I55ku9c5gk50hb>>;
export type I34avjcohag6bs = {
    "execution_result": Anonymize<I1jq01a88pudo4>;
    "emitted_events": Anonymize<I43ijq92tdrd94>;
    "local_xcm"?: Anonymize<I3i0ce56p044d2>;
    "forwarded_xcms": Anonymize<I47tkk5e5nm6g7>;
};
export type I43ijq92tdrd94 = Array<Anonymize<I3qph4htrql9sg>>;
export type I4bn8kb7mph889 = ResultPayload<Anonymize<Ibip7d4gdm75j>, Anonymize<I55ku9c5gk50hb>>;
export type Ibip7d4gdm75j = {
    "execution_result": XcmV4TraitsOutcome;
    "emitted_events": Anonymize<I43ijq92tdrd94>;
    "forwarded_xcms": Anonymize<I47tkk5e5nm6g7>;
};
